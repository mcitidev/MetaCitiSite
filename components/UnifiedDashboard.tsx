...
export function UnifiedDashboard({ image }: UnifiedDashboardProps) {
    ...
    return (
        <section id="dashboard" className="unified-dashboard [font-family:Inter,-apple-system,BlinkMacSystemFont,'Segoe_UI',Roboto,Arial,sans-serif] py-8 lg:py-15 bg-[#48424C] relative overflow-hidden">
            {/* Background pattern */}
